...
# ── Positioning↔Segmentation loop internal keys ───────────────────────────────
LOOP_EVAL_SIGNAL = "loop_eval_signal"   # written by loop_evaluator_agent (not in AGENT_OUTPUT_KEYS)
LOOP_FEEDBACK    = "loop_feedback"      # feedback written by evaluator for next iteration
...
DOWNSTREAM_KEYS: dict[str, list[str]] = {
    PRODUCT_PROFILE: [
        PRODUCT_PROFILE, MARKET_SEGMENTATION, AUDIENCE_ANALYSIS,
        TREND_RESEARCH, COMPETITOR_ANALYSIS, PRICING_ANALYSIS,
    ...
    MARKET_SEGMENTATION: [
        MARKET_SEGMENTATION, AUDIENCE_ANALYSIS,
        PRICING_ANALYSIS, CREATIVE_DIRECTIONS, SELECTED_PERSONA,
        IMAGE_GEN_PROMPT, AB_VARIANT_PROMPT,
        CAMPAIGN_ARCHITECTURE, EXPERIMENT_DESIGN,
        MARKETING_OUTPUT, EVALUATION_OUTPUT, CHANNEL_ADAPTATION, BRAND_CONSISTENCY,
    ],
    AUDIENCE_ANALYSIS: [
    ...
    TREND_RESEARCH: [
        TREND_RESEARCH, CREATIVE_DIRECTIONS, SELECTED_PERSONA,
        IMAGE_GEN_PROMPT, AB_VARIANT_PROMPT,
        CAMPAIGN_ARCHITECTURE, EXPERIMENT_DESIGN,
        MARKETING_OUTPUT, EVALUATION_OUTPUT, CHANNEL_ADAPTATION, BRAND_CONSISTENCY,
    ],
    COMPETITOR_ANALYSIS: [
        COMPETITOR_ANALYSIS, PRICING_ANALYSIS,
        CREATIVE_DIRECTIONS, SELECTED_PERSONA, IMAGE_GEN_PROMPT, AB_VARIANT_PROMPT,
        CAMPAIGN_ARCHITECTURE, EXPERIMENT_DESIGN,
        MARKETING_OUTPUT, EVALUATION_OUTPUT, CHANNEL_ADAPTATION, BRAND_CONSISTENCY,
    ],
    ...
    SELECTED_PERSONA: [
        SELECTED_PERSONA, IMAGE_GEN_PROMPT, AB_VARIANT_PROMPT,
        CAMPAIGN_ARCHITECTURE, EXPERIMENT_DESIGN,
        MARKETING_OUTPUT, EVALUATION_OUTPUT, CHANNEL_ADAPTATION, BRAND_CONSISTENCY,
    ],
    IMAGE_GEN_PROMPT: [
    ...
    CAMPAIGN_ARCHITECTURE: [
        CAMPAIGN_ARCHITECTURE, EXPERIMENT_DESIGN,
        MARKETING_OUTPUT, EVALUATION_OUTPUT, BRAND_CONSISTENCY,
    ],
    EXPERIMENT_DESIGN: [
        EXPERIMENT_DESIGN,
        MARKETING_OUTPUT, EVALUATION_OUTPUT, BRAND_CONSISTENCY,
